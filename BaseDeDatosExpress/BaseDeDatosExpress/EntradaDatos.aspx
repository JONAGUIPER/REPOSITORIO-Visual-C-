...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AdventureWorks2014ConnectionString %>" 
            SelectCommand="SELECT CustomerID, PersonID, StoreID, TerritoryID, AccountNumber, ModifiedDate FROM Sales.Customer" 
            UpdateCommand="UPDATE Sales.Customer SET ModifiedDate = @ModifiedDate WHERE (CustomerID = @CustomerID)" DeleteCommand="Delete Sales.Customer WHERE (CustomerID = @CustomerID)" 
            InsertCommand="INSERT INTO Sales.Customer(CustomerID, PersonID, StoreID, TerritoryID, ModifiedDate) VALUES (@CustomerID, @PersonID, @StoreID, @TerritoryID, GETDATE())">
            <UpdateParameters>
        ...
        <br />
        <asp:FormView ID="fvCodigo" runat="server" UpdateMethod="ActualizarFVCodigo">
            <EditItemTemplate>
                CustomerID:
                <asp:Label ID="CustomerIDLabel1" runat="server" Text='<%# Eval("CustomerID") %>' />
                <br />
